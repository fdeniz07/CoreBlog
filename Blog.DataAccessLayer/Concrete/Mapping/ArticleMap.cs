...
namespace Blog.DataAccessLayer.Concrete.Mapping
{
    public class ArticleMap:IEntityTypeConfiguration<Article>
    {
        public void Configure(EntityTypeBuilder<Article> builder)
        {
            ...
            builder.Property(a=>a.SeoTags).IsRequired().HasMaxLength(100);
            ...
            builder.HasOne<Writer>(a => a.Writer).WithMany(w => w.Articles).HasForeignKey(a => a.WriterId);

            builder.ToTable("Articles"); //Db deki tablo adi


            // ilk deger girisi (Fluent Api ile tüm degerler girilmedir (null gecilebilir olsa da))
