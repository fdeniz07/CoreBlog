...
namespace Blog.BusinessLayer.ValidationRules.FluentValidation.DtoValidators
{
    public class WriterAddDtoValidator : AbstractValidator<WriterAddDto>
    {
        private readonly ValidatorMessages _validatorMessages = new ValidatorMessages();

        public WriterAddDtoValidator()
        {
